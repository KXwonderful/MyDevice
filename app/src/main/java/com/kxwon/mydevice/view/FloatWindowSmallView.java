...
public class FloatWindowSmallView extends LinearLayout {
	...
	public FloatWindowSmallView(Context context) {
		...
		rocketImg.setBackgroundResource(R.drawable.anim_rocket);
		AnimationDrawable anim = (AnimationDrawable) rocketImg.getBackground();
		anim.start();
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			try{
				...
				Toast.makeText(getContext(),"可以移动下再点哦", Toast.LENGTH_SHORT).show();
			}
			break;
		default:
			break;
